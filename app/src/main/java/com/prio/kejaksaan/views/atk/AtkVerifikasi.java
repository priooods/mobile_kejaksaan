...
public class AtkVerifikasi extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        switch (UserModel.i.type){
            case "Pengelola Persediaan":
                binding.desc.setText("All History Request Verified");
                GetATkVerifLog();
                break;
            case "PP":
                binding.desc.setText("Click item to verified request before");
                GetATkVerifPP();
                break;
        }
    ...
    public void GetATkVerifLog(){
        Call<AtkModel> call = BaseModel.i.getService().ATkverifLog(BaseModel.i.token);
    ...
    public void GetATkVerifPP(){
        Call<AtkModel> call = BaseModel.i.getService().ATkverifPP(BaseModel.i.token);
        call.enqueue(new Callback<AtkModel>() {
            @Override
            public void onResponse(@NotNull Call<AtkModel> call, @NotNull Response<AtkModel> response) {
                AtkModel atkModel = response.body();
    ...
    public static class AdapterSelainLogistik extends RecyclerView.Adapter<AdapterSelainLogistik.vHolder>{
